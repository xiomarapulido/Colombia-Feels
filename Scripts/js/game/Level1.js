...
Game.Level1 = function (juego) { 
 ...
 //var this = new Phaser.Game(768, 500, Phaser.CANVAS, '', {preload: preload, create: create, update: update, render: render});
 			 // 1. Jugador
   ...
   //this.stage.backgroundColor='#7BF728';
              ...
              //  parámetros del jugador,  posición inicial
               ...
               // enemigos.animations.add('rightt', [8,9,10, 11], 10, true);
                /*enemigo=this.add.sprite(100,100,'enemigo');
                enemigo.frame=1;
               ...
               /* enemigo=this.add.sprite(300,100,'enemigo');
                enemigo.frame=1;
                enemigo.animations.add('derecha', [8,9,10, 11], 10, true);*/
                ...
                // permitir  a la cámara del this, seguir en todo momento al jugador               
